...
**Wikimedia Commons의 자유 라이선스 사진만 씁니다.** (현재 23곳 97장)
...
- **캡션만 보고 고르지 마세요. 이미지를 직접 열어보세요.** 검색 결과에 엉뚱한 게 섞여
  들어옵니다 — 桃園공항 출국장이 王有記茶行 후보에, 松山역·萬華역이 台北車站 후보에,
  士林 분점이 阿宗麵線 후보에 있었습니다. 시리즈 캡션(예: "迪化街逛舊街辦年貨")이
  붙어 있어도 실제 사진은 주차금지 표지판일 수 있습니다.
- **`upload.wikimedia.org`는 연속 요청에 429를 줍니다.** 클라우드 IP는 특히 심합니다.
  429를 404로 오해하면 멀쩡한 사진을 지우게 됩니다 — `check`가 사유를 구분해 찍습니다.
